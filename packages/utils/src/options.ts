...
export class Options {
  ...
  // When true, == and != in binding expressions use === and !== (strict equality).
  // Default true to preserve existing @tko/build.reference behavior.
  overloadEvilTwins: boolean = true
