  ...
  describe('slots', function () {
      ...
      new JsxObserver(
        {
          ...
          attributes: {},
          children: [{ elementName: 'template', attributes: { slot: 'X' }, children: ['t', 'o'] }]
        },
        testNode,
        null,
        null,
      ...
      class ViewModel extends components.ComponentABC {
        static override get template() {
          ...
          return {
            elementName: 'div',
            attributes: {},
            children: ['A', { elementName: 'slot', attributes: { name: 'X' }, children: [] }, 'B']
          }
        }
      }
        ...
        children: [
          {
            ...
            attributes: { slot: 'X' },
            children: [{ elementName: 'em', attributes: { attrx, attry: 'y', attrz: () => 'z' }, children: [] }]
          }
        ]
      }
      ...
      class ViewModel extends components.ComponentABC {
        static override get template() {
          ...
          return {
            elementName: 'div',
            attributes: {},
            children: [{ elementName: 'slot', attributes: { name: 'X' }, children: [] }]
          }
        }
      }
    ...
    it('respects observable array changes with text', function () {
      ...
      const jsx = {
        elementName: 'test-component',
        attributes: {},
        children: [{ elementName: 'template', attributes: { slot: 'X' }, children: [arr] }]
      }
