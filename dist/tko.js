(function (global, factory) {
  ...
  var utils = Object.freeze({
    ...
    setDomNodeChildren: setRegularDomNodeChildren,
  ...
  */
  ...
  function bindingContextConstructor(dataItemOrAccessor, parentContext, dataItemAlias, extendCallback, settings) {
  ...
  bindingContextConstructor.prototype.createChildContext = function (dataItemOrAccessor, dataItemAlias, extendCallback, settings) {
      return new bindingContextConstructor(dataItemOrAccessor, this, dataItemAlias, function(self, parentContext) {
  ...
  bindingContextConstructor.prototype.extend = function(properties) {
      // If the parent context references an observable view model, "_subscribable" will always be the
      // latest view model object. If not, "_subscribable" isn't set, and we can use the static "$data" value.
      return new bindingContextConstructor(this._subscribable || this.$data, this, null, function(self, parentContext) {
  ...
  bindingContextConstructor.prototype.createStaticChildContext = function (dataItemOrAccessor, dataItemAlias) {
  ...
  function getBindingContext(viewModelOrBindingContext) {
      return viewModelOrBindingContext && (viewModelOrBindingContext instanceof bindingContextConstructor)
          ? viewModelOrBindingContext
          : new bindingContextConstructor(viewModelOrBindingContext);
  }
