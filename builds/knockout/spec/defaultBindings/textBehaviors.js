describe('Binding: Text', function () {
  ...
  it('Should assign the value to the node, HTML-encoding the value', function () {
    ...
    expect(testNode.childNodes[0].textContent || testNode.childNodes[0].innerText).to.equal(model.textProp)
  })
  ...
  it('Should assign an empty string as value if the model value is null', function () {
    ...
    var actualText =
      'textContent' in testNode.childNodes[0] ? testNode.childNodes[0].textContent : testNode.childNodes[0].innerText
  ...
  it('Should not attempt data binding on the generated text node', function () {
    ...
    expect('textContent' in testNode ? testNode.textContent : testNode.innerText).to.equal('hello')
  })
})
