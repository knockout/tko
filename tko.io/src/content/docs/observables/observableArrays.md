...
To see how you can bind the `observableArray` to a UI and let the user modify it, see the examples on the [`foreach` binding](../bindings/foreach-binding/) page.
