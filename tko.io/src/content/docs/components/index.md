...
For this to work, you need to provide matching `component-like-widget.js` and `component-like-widget.html` files in your project. The filenames shown here are illustrative; in a real app, these would be modules and templates that your loader knows how to resolve.
