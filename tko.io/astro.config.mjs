  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Bindings', collapsed: true, items: [{ autogenerate: { directory: 'bindings' } }] },
        { label: 'Observables', collapsed: true, items: [{ autogenerate: { directory: 'observables' } }] },
        { label: 'Computed', collapsed: true, items: [{ autogenerate: { directory: 'computed' } }] },
        { label: 'Components', collapsed: true, items: [{ autogenerate: { directory: 'components' } }] },
        { label: 'Binding Context', collapsed: true, items: [{ autogenerate: { directory: 'binding-context' } }] },
        { label: 'Advanced', collapsed: true, items: [{ autogenerate: { directory: 'advanced' } }] },
