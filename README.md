...
**TKO** is divided into several sub-projects, including:

- [tko.tools](https://github.com/knockout/tko.tools)
- [tko.utils](https://github.com/knockout/tko.utils)
- [tko.observable](https://github.com/knockout/tko.observable)
